...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://sourabhbajaj.com/}{\Large Anthony Chang}} & Email : \href{anthony.chang@utexas.edu}{anthony.chang@utexas.edu}\\
  \href{https://www.linkedin.com/in/anthony-chang1/}{https://www.linkedin.com/in/anthony-chang1/} & Mobile : 281-961-4501 \\
  \href{https://github.com/MasterSushiChef}{https://github.com/MasterSushiChef}
\end{tabular*}
...
\section{Education}
  \textbf{University of Texas at Austin}{Austin, TX}
      {Bachelor of Science in Aerospace Engineering;  GPA: 3.88}{Aug. 2018 -- Dec. 2021}
      {Intended Certificate: Computational Engineering}
...
\section{Programming Skills}
  \textbf{Computer Languages}{: Python, C++, Javascript, Java, MATLAB}\\
  \textbf{Technologies}{: Git, Node.js, Docker, InfluxDB, Grafana, Solidworks}\\
  \textbf{Languages}{: Chinese, Japanese (conversational fluency)}
